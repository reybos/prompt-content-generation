/**
 * Optimized Title Prompt for Poems Song Shorts
...
const poemsTitlePrompt: PromptTemplate = new PromptTemplate({
    inputVariables: ["songLyrics", "videoPrompt"],
    template: titleDescPromptTemplate
});

export function logPoemsTitlePrompt(songLyrics: string, videoPrompt: string): void {
    console.log('\n=== POEMS TITLE PROMPT ===');
