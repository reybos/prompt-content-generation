export const defaultStyle = {
  name: "default",
  displayName: "Classic",
  description: "Classic cartoon children's style with bold outlines, flat colors, and friendly characters",
  
  // Детальное описание стиля животных
  characterStyle: "Classic cartoon animals with bold, black outlines and flat, vibrant colors. Exaggerated, expressive features with large, round eyes and simple facial expressions. Smooth, rounded forms with no sharp edges. Characters have a warm, approachable appearance that appeals to children. Simple, clean design with minimal shading, focusing on bold colors and clear shapes",
